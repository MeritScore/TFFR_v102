      ...
      <div className="relative bg-[#09090b] rounded-[30px] p-4 overflow-hidden">
        ...
        <div className="flex flex-col items-center mt-8 mb-8 relative z-10">
            <div className="relative w-36 h-36 flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 100 100">
                    ...
                    <circle cx="50" cy="50" r="46" stroke="url(#greenGradient)" strokeWidth="3" fill="none" strokeDasharray="289" strokeDashoffset="45" strokeLinecap="round" className="drop-shadow-[0_0_8px_rgba(57,255,20,0.5)]" />
                </svg>
                <div className="relative w-28 h-28 rounded-full overflow-hidden border-2 border-black">
                    <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=300&auto=format&fit=crop" alt="Profile" className="w-full h-full object-cover" />
                    <div className="absolute inset-0 ring-inset ring-2 ring-black/20 rounded-full pointer-events-none"></div>
                </div>
                <div className="absolute -bottom-4 z-20 bg-black border border-cyber-green px-5 py-1.5 rounded-lg flex flex-col items-center shadow-[0_4px_20px_rgba(0,0,0,0.8)]">
                    <span className="text-xl font-rajdhani font-black text-white leading-none">245</span>
                    <span className="text-[7px] font-orbitron font-bold text-cyber-green tracking-wider">MERIT SCORE</span>
                </div>
            </div>
            <h2 className="text-2xl font-orbitron font-black text-white mt-6 tracking-wide drop-shadow-md">Neo_Runner_99</h2>
            <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">LOGISTICS SPECIALIST</p>
        </div>
        <div className="space-y-4 px-2 mb-8 animate-slide-up">
            ...
            <div className="grid grid-cols-3 gap-2">
                 <div className="bg-[#121214] rounded-xl p-3 flex flex-col items-center justify-center border-b-[3px] border-cyber-green relative overflow-hidden h-24 shadow-lg">
                     ...
                     <span className="text-xl font-rajdhani font-black text-white z-10 leading-none">98%</span>
                 ...
                 <div className="bg-[#121214] rounded-xl p-3 flex flex-col items-center justify-center border-b-[3px] border-cyber-cyan relative overflow-hidden h-24 shadow-lg">
                     ...
                     <span className="text-xl font-rajdhani font-black text-white z-10 leading-none">HIGH</span>
                 ...
                 <div className="bg-[#121214] rounded-xl p-3 flex flex-col items-center justify-center border-b-[3px] border-cyber-yellow relative overflow-hidden h-24 shadow-lg">
                     ...
                     <span className="text-xl font-rajdhani font-black text-white z-10 leading-none">TOP 5%</span>
        ...
        <div className="space-y-5 mb-8 px-2">
            ...
            <div className="space-y-4">
                <div>
                    <div className="flex justify-between text-[10px] font-bold font-mono mb-1"><span className="text-gray-300 tracking-wider">CONSISTENCY (RELIABILITY)</span><span className="text-cyber-green">98%</span></div>
                    <div className="h-1.5 w-full bg-gray-900 rounded-full overflow-hidden border border-white/5"><div className="h-full bg-cyber-green w-[98%] shadow-[0_0_10px_#39ff14]"></div></div>
                </div>
                <div>
                    <div className="flex justify-between text-[10px] font-bold font-mono mb-1"><span className="text-gray-300 tracking-wider">VELOCITY (SPEED)</span><span className="text-cyber-cyan">85%</span></div>
                    <div className="h-1.5 w-full bg-gray-900 rounded-full overflow-hidden border border-white/5"><div className="h-full bg-cyber-cyan w-[85%] shadow-[0_0_10px_#00ffff]"></div></div>
                </div>
                <div>
                    <div className="flex justify-between text-[10px] font-bold font-mono mb-1"><span className="text-gray-300 tracking-wider">COMPLEXITY (SKILL)</span><span className="text-cyber-yellow">92%</span></div>
                    <div className="h-1.5 w-full bg-gray-900 rounded-full overflow-hidden border border-white/5"><div className="h-full bg-cyber-yellow w-[92%] shadow-[0_0_10px_#ffee00]"></div></div>
                </div>
            </div>
        ...
        <div className="space-y-4 mb-8 px-2">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#121214] border border-white/10 rounded-2xl p-4 flex flex-col items-center justify-center relative shadow-lg">
                    ...
                    <div className="relative w-20 h-20 flex items-center justify-center">
                        <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 100 100">
                            ...
                            <circle cx="50" cy="50" r="42" stroke="#39ff14" strokeWidth="6" fill="none" strokeDasharray="264" strokeDashoffset="40" strokeLinecap="round" className="drop-shadow-[0_0_8px_#39ff14]" />
                        </svg>
                        <span className="text-sm font-black font-rajdhani text-white z-10">85%</span>
                    </div>
                </div>
                <div className="bg-[#121214] border border-white/10 rounded-2xl p-4 flex flex-col justify-center shadow-lg">
                    ...
                    <span className="text-3xl font-rajdhani font-black text-white tracking-tight">$2500</span>
        ...
        <div className="space-y-5 px-2">
            <div>
                ...
                <p className="text-xs text-gray-300 font-sans leading-relaxed border-l-2 border-cyber-green/30 pl-3">Expert in navigating high-density crowds. I know every shortcut in the stadium. Fast, reliable, and I never drop a delivery.</p>
            </div>
            <div>
                <h4 className="text-[10px] font-mono text-gray-500 uppercase mb-3 tracking-widest">SKILLS & EQUIPMENT</h4>
                <div className="flex flex-wrap gap-2">
                    {['CROWD NAV', 'HEAVY LIFTING', 'VIP ESCORT'].map(tag => (
